...
@test "${BATS_TEST_NUMBER} run start" {
  execute_test_command
  assert_output "$( cat <<EOF
stopping app
linting all files
...
@test "${BATS_TEST_NUMBER} run complex" {
  execute_test_command
  assert_output "$( cat <<EOF
--- for loops ---
 abc :: hjkl :: xyz ::
...
--- if constructs ---
 abc :: hjkl :: abc ::
--- for loops :: pathological semicolon usage ---
 abc :: hjkl :: xyz ::
 abc :: hjkl :: xyz ::
 abc :: hjkl :: xyz ::
--- while loops :: pathological semicolon usage ---
 abc :: hjkl :: xyz ::
 abc :: hjkl :: xyz ::
 abc :: hjkl :: xyz ::
--- if constructs :: pathological semicolon usage ---
 abc :: hjkl :: abc ::
EOF
  )"
  assert_success
